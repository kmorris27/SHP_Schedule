...
SWIFT_CLASS("_TtC12SHP_Schedule16DayTableViewCell")
...
SWIFT_CLASS("_TtC12SHP_Schedule23RootSplitViewController")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified latestSyncTimeLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified latestPublishedTimeLabel;
- (void)viewDidLoad;
- (void)viewWillDisappear:(BOOL)animated;
